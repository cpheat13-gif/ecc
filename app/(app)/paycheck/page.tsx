          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="text-gray-500 text-xs uppercase tracking-wide">
                ...
                <th className="text-right pb-3">Goal</th>
                <th className="text-right pb-3 hidden sm:table-cell">% of Income</th>
              </tr>
            </thead>
              ...
              {vaults.map((vault) => (
                <tr key={vault.id}>
                  <td className="py-2.5">
                    ...
                    {vault.id === 'credit-card' && (
                      <span className="ml-2 text-xs text-indigo-400 font-normal">auto</span>
                    )}
                  </td>
                  ...
                  <td className="text-right py-2.5 text-gray-500 hidden sm:table-cell">
                    {totalMonthlyGoals > 0
            ...
            <tfoot>
              <tr className="border-t-2 border-gray-200">
                ...
                <td className="pt-3 text-right text-gray-500 hidden sm:table-cell">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="text-gray-400 text-xs">
                      ...
                      <th className="text-right pb-2">Per Check</th>
                      <th className="text-right pb-2 hidden sm:table-cell">Monthly</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-100 divide-opacity-50">
                    {breakdown.distributions.map(dist => (
                      <tr key={dist.vault_id}>
                        ...
                        <td className="text-right py-2 font-medium text-gray-900 hidden sm:table-cell">
                  ...
                  <tfoot>
                    <tr className="border-t-2" style={{ borderColor: m.color === 'blue' ? '#bfdbfe' : '#fbcfe8' }}>
                      ...
                      <td className="pt-3 text-right font-bold text-gray-900 hidden sm:table-cell">
